...
lineReader.on('line', function (line) {xw
  if (line.includes(COMMAND)) {
    ...
    console.log(line);
    console.log(iCommandContents.substring(iCommandContents - 1));
    if (iCommandContents.substring(iCommandContents - 1) === ',') {
      iCommandContents = iCommandContents.substring(iCommandContents - 2) + RUN_COMMAND + ','; // with trailing comma
    } else {
